...
==================================
${Green_font_prefix} 1.${Font_color_suffix} v1 ${Green_font_prefix} 2.${Font_color_suffix} v2  ${Green_font_prefix} 3.${Font_color_suffix} v3  ${Green_font_prefix} 4.${Font_color_suffix} v4 ${Green_font_prefix} 5.${Font_color_suffix} v5 ${Green_font_prefix} 6.${Font_color_suffix} v6
=================================="
...
$(if [[ ${ver} != "6" && ${obfs} != "off" ]]; then echo "obfs-host = ${host}"; fi)
tfo = ${tfo}
dns = ${dns}
$(if [[ ${ver} == "6" ]]; then 
...
# 设置协议版本
Set_ver(){
	echo -e "配置 Snell Server 协议版本${Yellow_font_prefix}[1-6]${Font_color_suffix} 
==================================
